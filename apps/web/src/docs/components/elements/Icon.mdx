...
|------|------|---------|-------------|
| `name` | `string` | - | The icon name (home, user, settings, etc.) |
| `children` | `React.ReactNode` | - | Custom SVG content |
| `size` | `'xs' \| 'sm' \| 'md' \| 'lg' \| 'xl' \| '2xl'` | `'md'` | Size variant |
| `color` | `'default' \| 'primary' \| 'success' \| 'warning' \| 'error' \| 'info' \| 'muted' \| 'white' \| 'black'` | `'default'` | Color variant |
| `animation` | `'none' \| 'spin' \| 'pulse' \| 'bounce'` | `'none'` | Animation variant |
